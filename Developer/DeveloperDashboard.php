            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active bg-primary" style="padding-top:15px;color:white;">
                        <a style="color: white;" href="DeveloperDashboard.php"><i style="color: white;" class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    <li class="nav-item">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="row mx-5 text-center">
                <div class="col-sm-4 text-white mt-5">
                    <div class="card box card-box p-2 bg-info text-white mb-3; max-width:18rem;">
                        <div class="card-header text-white">Tickets Critical</div>
                        <div class="card-body">
                ...
                <div class="col-sm-4 mt-5 text-center">
                    <div class="card box card-box p-2 bg-success text-whte mb-3 ; max-width:18rem;">
                        <div class="card-header text-white">Tickets Priority High</div>
                        <div class="card-body">
                            <div class="align-self-center">
                ...
                <div class="col-sm-4 mt-5 text-center">
                    <div class="card box card-box p-2 bg-success text-whte mb-3 ; max-width:18rem;">
                        <div class="card-header text-white">Tickets Priority Emergency</div>
                        <div class="card-body">
                            <div class="align-self-center">
                                <i class="icon-user float-left text-white" style="font-size: 3.5rem;"></i>
                            </div>
                            <h3 class="card-title text-white text-right" style="font-size:3.5rem;">4</h3>
                        </div>
                    </div>
                </div>
            </div>
