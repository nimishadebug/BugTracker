...
if (isset($_POST['insert'])) {
    ...
    $sql = "INSERT INTO `comment_db`(commented_project, comment_desc, commented_by, commentedby_id)VALUES('$TID', '$commentdesc', '$username', '$userid')";
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="nav-item" style="padding-top:15px;color:white;">
                    ...
                    <li class="active bg-primary">
                        <a style="color: white;" href="ProjectManagerTickets.php"><i style="color: white;" class="menu-icon fa fa-ticket"></i>My Tickets </a>
                    </li>
                    <li class="nav-item">
                        <a href="ChangeProfileSettings.php"><i class="menu-icon fa fa-key"></i>Change Profile Settings </a>
                    </li>
                ...
                <div class="col-sm-4 text-white text-center mt-2">
                    <div class="card box p-2 text-white mb-3;">
                        ...
                        <div class="card-body" style="color: black;">
                            ...
                            <?php
                            $sqli = mysqli_query($conn, "SELECT request_info FROM submitrequest_db WHERE request_id ='$TID'");
                ...
                <div class="col-sm-4 text-white text-center mt-2">
                    <div class="card box p-2 text-white mb-3;">
                        ...
                        <div class="card-body" style="color: black;">
                            ...
                            <?php
                            $sqli = mysqli_query($conn, "SELECT request_desc FROM submitrequest_db WHERE request_id = '$TID'");
                            while ($row = mysqli_fetch_array($sqli)) {
                            ?>
                ...
                <div class="col-sm-4 text-white text-center mt-2">
                    <div class="card box p-2 text-white mb-3;">
                        ...
                        <div class="card-body" style="color: black;">
                            ...
                            <?php
                            $sqli = mysqli_query($conn, "SELECT request_topic FROM submitrequest_db WHERE request_id = '$TID'");
                            while ($row = mysqli_fetch_array($sqli)) {
                            ?>
                ...
                <div class="col-sm-4 text-white text-center mt-2">
                    <div class="card box p-2 text-white mb-3;">
                        ...
                        <div class="card-body" style="color: black;">
                            ...
                            <?php
                            $sqli = mysqli_query($conn, "SELECT request_priority FROM submitrequest_db WHERE request_id ='$TID'");
                            while ($row = mysqli_fetch_array($sqli)) {
                            ?>
                ...
                <div class="col-sm-4 text-white text-center mt-2">
                    <div class="card box p-2 text-white mb-3;">
                        ...
                        <div class="card-body" style="color: black;">
                            ...
                            <?php
                            $sqli = mysqli_query($conn, "SELECT request_status FROM submitrequest_db WHERE request_id = '$TID'");
                            while ($row = mysqli_fetch_array($sqli)) {
                            ?>
                ...
                <div class="col-sm-4 text-white text-center mt-2">
                    <div class="card box p-2 text-white mb-3;">
                        ...
                        <div class="card-body" style="color: black;">
                            ...
                            <?php
                            $sqli = mysqli_query($conn, "SELECT request_time FROM submitrequest_db WHERE request_id = '$TID'");
                            while ($row = mysqli_fetch_array($sqli)) {
                            ?>
                        ...
                        <div class="card-body" style="color: black;">
                            ...
                            <table class="table display table-bordered mt-5" style="width:100%">
                                ...
                                <tbody style="text-align:center;background-color:white;">
                                    ...
                                    $sql = "SELECT c_id, comment_desc, commented_by, commented_project, comment_time FROM comment_db WHERE commented_project = '$TID'";
                                    $result = $conn->query($sql);
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $CID = $row['c_id'];
                    ...
                    <div class="card-body" style="color: black;">
                        ...
                        <table class="table display table-bordered mt-5" style="width:100%">
                            ...
                            <tbody style="text-align:center;background-color:white;">
                                ...
                                $sql = "SELECT c_id, comment_desc, commented_by, commented_project, comment_time FROM comment_db WHERE commented_project = '$TID' AND commentedby_id = $userid";
                                $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        $CID = $row['c_id'];
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $CTB ?></td>
                                            <td><?php echo $CCT ?></td>
                                            <td><a href="editcomment.php?GetID=<?php echo $CID ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="deletecomment.php?Del=<?php echo $CID ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                <?php
                                    }
                                    echo "</table>";
                            ...
                            <tbody style="text-align:center;background-color:white;">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $RTP ?></td>
                                            <td><?php echo $RTU ?></td>
                                            <td><a href="editticketdetail.php?GetID=<?php echo $RID ?>" class="btn btn-warning">Edit</a> </td>
                                            <td><a href="deleteticketdetail.php?Del=<?php echo $RID ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                <?php
                                    }
                                    echo "</table>";
