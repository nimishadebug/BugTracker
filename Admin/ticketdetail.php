                    ...
                    <div class="card-body" style="color: black;">
                        ...
                        <table class="table display table-bordered mt-5" style="width:100%">
                            ...
                            <tbody style="text-align:center;background-color:white;">
                                ...
                                $sql = "SELECT c_id, comment_desc, commented_by, commented_project, comment_time FROM comment_db WHERE commented_project = '$TID' AND commentedby_id = $_SESSION[login]";
                                $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        $CID = $row['c_id'];
