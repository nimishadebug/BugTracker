                            ...
                            <div class="card-body">
                                <table class="table display table-bordered table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr><td>" . $row["request_topic"] . "</td><td>" . $row["request_info"] . "</td><td>" . $row["request_priority"] . "</td><td>" .$row["request_status"] .  "</td><td>" . $row["request_time"] . "</td></tr>";
                                            }
                                            echo "</table>";
                                        } else {
                                            //echo "NO RESULT";
                            ...
                            <div class="card-body">
                                <table class="table display table-bordered table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        //$sql = "SELECT r_login_id, r_name, r_email, r_select FROM  userregistration_db";
                                        $sql = "SELECT project_db.p_id, project_db.p_name, submitrequest_db.request_id,submitrequest_db.request_info, submitrequest_db.request_priority, submitrequest_db.request_desc,submitrequest_db.r_name, 
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                $RID = $row["request_id"];
                                                $RTT = $row["request_topic"];
                                                $RTI = $row["request_info"];
                                                $RTP = $row["request_priority"];
                                                $RTD = $row["request_desc"];
                                                $RTIM = $row["request_time"];
                                                //echo "<tr><td>" . $row["request_topic"] . "</td><td>" . $row["request_info"] . "</td><td>" . $row["request_priority"] . "</td><td>" . $row["request_desc"] ."</td><td>" .$row["request_time"] . "</td></tr>";
                                           ?>

                                            <tr>
                                                        <td><a style="color: #36b9cc;" href="detailprojecttickettopic.php?GetTicket=<?php echo $RID ?>"><?php echo $RTT?></a></td>
                                                        <td><?php echo $RTI ?></td>
                                                        <td><?php echo $RTP ?></td>
                                                        <td><?php echo $RTD ?></td>
                                                        <td><?php echo $RTIM ?></td>
