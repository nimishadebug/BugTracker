        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background-color: #f8f8f8;">
            ...
            <ul class="nav navbar-nav">
                     ...
                     <li class="active bg-primary">
                         <a style="color: white;" href="ProjectManagerProjects.php"><i style="color: white;" class="menu-icon fa fa-tasks"></i>My Projects </a>
                     </li>
                     <li class="nav-item">
                    ...
                    <div class="col-lg-12">
                        <div class="card" style="color:#5777ba;">
                            <div class="mx-5 mt-5 text-center">
                                <div class="card-header p-4 bg-primary" style="color: white;">ALL PROJECTS</div>
                                <div class="card-body">
                                        ...
                                        <tbody style="text-align:center;background-color:white;">
                                            ...
                                            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="editproject.php?GetID=<?php echo $PID ?>" class = "btn btn-warning">Edit</a></td>
                                                        <td><a href="deleteproject.php?Del=<?php echo $PID ?>" class = "btn btn-danger">Delete</a></td>
                                                        <td><a href="detailproject.php?Detail=<?php echo $PID ?>" class = "btn btn-success">Details</a></td>
                                                    </tr>
