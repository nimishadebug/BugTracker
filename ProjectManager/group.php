    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content" style="background-color: white;">
            ...
            <div class="card" style="color:#5777ba;">
                ...
                <?php
                //$c_query = $conn->query("SELECT * FROM `project_db` WHERE `p_id` = '$_REQUEST[pid]'");
                ...
                <!--<div id="loading" style="display:flex; justify-content:center;"></div>-->
            </div>
            ...
            <div class="newcontent" style="background-color: white;margin-bottom:72px;">
                ...
                <div class="card" style="color:#5777ba;">
                    <div class="row mx-5 text-center">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="form-group">
                                        <select name="removedeveloper" class="form-control" multiple="multiple">
                                            ...
                                            <?php
                                            //$sql = "SELECT * FROM `new_r_login_p_id` NATURAL JOIN `userregistration_db` NATURAL JOIN `project_db` WHERE new_r_login_p_id.r_developer = userregistration_db.r_login_id AND `p_id` = '$c_fetch[p_id]'";
                                            //$sql = "SELECT new_r_login_p_id.p_id, new_r_login_p_id.r_developer, userregistration_db.r_login_id,
                                            //userregistration_db.r_name FROM new_r_login_p_id, userregistration_db WHERE new_r_login_p_id.r_developer = userregistration_db.r_login_id
                                            //AND p_id = {$_GET['pid']}"; 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="removemanager" class="form-control" multiple="multiple">
                                            ...
                                            <?php
                                            //$sql = "SELECT * FROM `new_r_login_p_id` NATURAL JOIN `userregistration_db` NATURAL JOIN `project_db` WHERE new_r_login_p_id.r_pmanager = userregistration_db.r_login_id AND `p_id` = '$c_fetch[p_id]'";
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="form-group">
                                        <select name="removeuser" class="form-control" multiple="multiple">
                                            ...
                                            <?php
                                            //$sql = "SELECT * FROM `new_r_login_p_id` NATURAL JOIN `userregistration_db` NATURAL JOIN `project_db` WHERE `p_id` = '$c_fetch[p_id]' AND new_r_login_p_id.r_user = userregistration_db.r_login_id ";
                        ...
                        <div class="col-sm-12">
                            <!--<button type="button" id="save_group" name="inremove" class="btn btn-primary btn-large btn-block">Remove User(s)</button>-->
