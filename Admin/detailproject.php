...
if (isset($_POST['insert'])) {
    ...
    $sql = "INSERT INTO new_r_login_p_id(p_id,r_developer,r_pmanager,r_user)VALUES('$TID','$rdeveloper','$rpmanager','$ruser')";
...
if (isset($_POST['inremove'])) {
    ...
    $sqli = "DELETE FROM new_r_login_p_id WHERE p_id = '$TID' AND r_developer = '$removedeveloper' && r_pmanager = '$removepmanager' && r_user = '$removeuser'";
                                    ...
                                    <div class="card-box">
                                        <div id="wrapper" style="width:280px;padding:16px;height:110px;">
                                            <div class="form-group">
                                             ...
                                             new_r_login_p_id.r_developer = userregistration_db.r_login_id AND p_id = '$TID'";
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT project_db.p_id, project_db.p_name, submitrequest_db.request_id,
                                                 submitrequest_db.request_info, submitrequest_db.request_topic, submitrequest_db.request_priority,
                                                  ...
                                                  AND submitrequest_db.p_id={$_GET['GetProject']}";
                                        $result = $conn->query($sql);
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                $PID = $row['p_id'];
                                        ...
                                        ?>        
                                                   <tr>
                                                        <td><a style="color: #36b9cc;" href="projectticketdetail.php?GetProjectDetail=<?php echo $RIDI ?>"><?php echo $RTT ?></a></td>
                                                        <td><?php echo $RII ?></td>
                                                        <td><?php echo $RIP ?></td>
                                                        <td><?php echo $RTI ?></td>
