...
<head>
    ...
    <title>User Dashboard - BugTracker</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background-color:#f8f8f8;">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active bg-primary" style="padding-top:15px;">
                        <a style="color: white;" href="UserDashboard.php"><i style="color: white;" class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    <li class="nav-item">
                        <a href="Projects.php"><i class="menu-icon fa fa-book"></i>Projects </a>
                    </li>
                    <li class="nav-item">
                        <a href="SubmitRequest.php"><i class="menu-icon fa fa-wheelchair"></i>Create Ticket </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="#"><i class="fa fa- user"></i>Notifications <span class="count"><?php echo $unread ?></span></a>
                        ...
                        <div class="card cardbg">
                            <div class="text-center">
                                <a href="SubmitRequest.php">
                                    <div class="card-header bg-primary">
                                        <h6 style="color: white;">MANAGE TICKETS</h6>
