...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>BugTracker App To Track Your Bugs. </h1>
            <a href="#form" class="download-btn"> SignUp </a>
            <a href="UserLogin.php" class="download-btn"> Login </a>
          </div>
        </div>
  ...
  <main id="main">
    ...
    <!--//To Connect the userregistration.php Page-->
   ...
   <!-- <section id="faq" class="faq section-bg">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <h6>Hi, This is my github profile: <a href="https://github.com/nimishadebug">Nimisha Dubey</a></h6>
        </div>
