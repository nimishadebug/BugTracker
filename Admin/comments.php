                            ...
                            <div class="mx-5 mt-5 text-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myTable" class="table display table-bordered table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th scope="col" style="text-align:center;">Comment Description</th>
                                        ...
                                        <tbody>
                                            <?php
                                             ...
                                             comment_db.comment_time, submitrequest_db.request_id, submitrequest_db.request_info, submitrequest_db.r_name FROM
                                              comment_db, submitrequest_db WHERE comment_db.commented_project = submitrequest_db.request_id";
                                            $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {

                                                    $CDS = $row['comment_desc'];
                                                    $RIN = $row['request_info'];
                                                    $TIM = $row['comment_time'];
                                                    $CID = $row['c_id'];
