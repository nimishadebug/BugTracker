        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background-color: #f8f8f8;">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="nav-item" style="padding-top:15px;color:white;">
                     ...
                     <li class="nav-item">
                         <a href="Developerproject.php"><i class="menu-icon fa fa-tasks"></i>My Projects </a>
                     </li>
                     <li class="nav-item">
                         <a href="Developerticket.php"><i class="menu-icon fa fa-ticket"></i>My Tickets </a>
                     </li>
                     <li class="active bg-primary">
                         <a style="color: white;" href="ChangeProfileSetting.php"><i style="color: white;" class="menu-icon fa fa-key"></i>Change Profile Settings </a>
                     </li>
