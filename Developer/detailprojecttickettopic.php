                            ...
                            <tbody style="text-align:center;background-color:white;">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $CTB ?></td>
                                            <td><?php echo $CCT ?></td>
                                            <td><a href="detailprojectticketcommentedit.php?GetID=<?php echo $CID ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="detailprojectticketcommentdelete.php?Del=<?php echo $CID ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                <?php
                                    }
                                    echo "</table>";
                            ...
                            <tbody style="text-align:center;background-color:white;">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $RTP ?></td>
                                            <td><?php echo $RTU ?></td>
                                            <td><a href="editticket.php?GetID=<?php echo $PID ?>" class="btn btn-warning">Edit</a> </td>
                                            <td><a href="deleteticketdetail.php?Del=<?php echo $PID ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                <?php
                                    }
                                    echo "</table>";
