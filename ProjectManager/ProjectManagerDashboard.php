...
$sql = mysqli_query($conn, "SELECT new_r_login_p_id.p_id, new_r_login_p_id.r_pmanager, project_db.p_id, project_db.p_name FROM new_r_login_p_id, project_db WHERE new_r_login_p_id.status_pmanager = 0 AND new_r_login_p_id.r_pmanager = $userid  AND new_r_login_p_id.p_id = project_db.p_id ");
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active bg-primary" style="padding-top:15px;color:white;">
                        <a style="color: white;" href="ProjectManagerDashboard.php"><i style="color: white;" class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="top-right" style="padding-right:15px;">
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="ChangePassword.php" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
