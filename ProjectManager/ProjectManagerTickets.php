                                        ...
                                        <tbody style="text-align:center;background-color:white;">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="deleteticket.php?Del=<?php echo $TID ?>" class = "btn btn-danger">Delete</a></td>
                                                        <td><a href="detailticket.php?TDetail=<?php echo $TID ?>" class = "btn btn-success">Details</a></td>
                                                    </tr>
                                            <?php
                                                }
                                                echo "</table>";
